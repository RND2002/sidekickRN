...
//   function handleProfileCardClick(userId){
//     naviation.navigate('ProviderProfile',{userId:userId})
//   }
//   return (
...
function ProviderCard({ id, userId, name, profession, availability }) {
  ...
  return (
    <Pressable
  onPress={handleProfileCardClick}
  style={{
    backgroundColor: 'rgba(0,0,0,0.1)',
    zIndex: 10, // Try increasing the zIndex
    elevation: 5,
  }}>
  <Text>Press me</Text>
</Pressable>
